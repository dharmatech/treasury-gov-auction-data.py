...
# ----------------------------------------------------------------------
custom_colors = [
    bokeh.palettes.Category20c[20][5], # bill
    bokeh.palettes.Category20c[20][9], # note
    bokeh.palettes.Category20c[20][0], # bond
]

stacked_items = ['Bill', 'Note', 'Bond']
# ----------------------------------------------------------------------
...
# p.vbar_stack(stackers=stacked_items, x='date', width=width, color=custom_colors, source=pivot_df[pivot_df < 0].fillna(0), legend_label=stacked_items, line_width=0)
# p.vbar_stack(stackers=stacked_items, x='date', width=width, color=custom_colors, source=pivot_df[pivot_df > 0].fillna(0), legend_label=stacked_items, line_width=0)
